...
/* External objects */
extern juju_int line; /* Source code line numbers - defined in scanner.c */
 ...
 * -------------------------------------------------------------
 */
juju_void printScannerError(juju_char* fmt, ...);
juju_void displayScanner(BufferReader* ptrBuffer);
juju_long getScannerFilesize(juju_char* fname);
